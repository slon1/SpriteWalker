...
namespace View {
	public class VirtualScreen : MonoBehaviour {
		...
		private Vector2 cellSize; // –азмер €чеек в пиксел€х		
		private Vector2 spriteSize;
		private Vector2 spritePosition;
		// ѕреобразуем размер €чеек из пикселей в мировые координаты
		...
		//	// ѕолучаем размер спрайта в мировых координатах
		...
		//	// –исуем вертикальные линии и выводим координаты
		...
		//	// –исуем горизонтальные линии и выводим координаты
		...
		public Vector2 GetCellScreenPosition(int x, int y) {
			...
			//Vector3 screenPos = Camera.main.WorldToScreenPoint(cellPosition);
